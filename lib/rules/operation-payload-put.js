 ...
 * @param {Object} get The get object being checked.
 * @param {Object} errorList The local list of errors.
 *
 * @returns {boolean} isValid returns true if the get object is valid.
 */
...
/**
 * Returns an object with info about the put parameter.
 * Inserts errors and sets isValid to false if not valid.
 *
 * @param {Object} pathKey The entire path key used for logging errors.
 * @param {Object} put The put object being checked.
 * @param {Object} errorList The local list of errors.
 *
 * @returns {Object} object A complex object as a cache of fields that have already been fetched.
 */
